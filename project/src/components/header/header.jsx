  ...
  return (
    <header className="page-header">
      <div className="page-header__content">
        ...
        <div
          className={`page-header__left ${page !== AppRoute.INDEX ? 'page-header__left--active' : ''}`}
          tabIndex={page !== AppRoute.INDEX ? "0" : "-1"}
          onClick={handleLogoClick}
          onKeyDown={handleEnterKeyDown}
        >
            <img className="page-header__logo" src="img/logo.svg" width="67" height="70" alt="Логотип"/>
          </div>
          ...
          <div className="page-header__right">
            <Link className="page-header__extra-link" to="/blank">
              <svg className="page-header__icon page-header__icon--location"  width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link className="page-header__extra-link" to="/blank">
              <svg className="page-header__icon page-header__icon--search" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link className="page-header__extra-link" to={AppRoute.CART}>
              <svg className="page-header__icon page-header__icon--cart" width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
